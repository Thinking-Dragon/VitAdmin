...
namespace VitAdmin.Data
{
    class DataModelNotesMed
    {
        ...
        public static List<NoteMedecin> GetPrescriptionsCitoyens(String NumAssMaladie)
        {
            ...
            /*  if (ConnexionBD.Instance().EstConnecte())
              {
                  ...
                  ConnexionBD.Instance().ExecuterRequete(
                      "SELECT note nte, em.nom, em.prenom, em.numEmploye, e.dateHeure " +
                      "FROM notesMedecin " +
                      "INNER JOIN employes em on em.idEmploye = e.idEvenement " +
            ...
            /*SELECT note nte, em.nom, em.prenom, em.numEmploye, e.dateHeure 
                    ...
                    INNER JOIN hospitalisations h on h.idHospitalisation = e.idHospitalisation
                    INNER JOIN citoyens c on c.idCitoyen = h.idCitoyen 
                    WHERE c.numAssuranceMaladie = 'tous059615' AND (prescriptions.dateDebut + INTERVAL nbJour DAY >= CURDATE() OR nbJour = 0)*/
